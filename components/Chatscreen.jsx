...
const Chatscreen = (props) => {
  ...
  return (
    <div className="flex flex-col w-full h-screen justify-center items-center bg-gray-100 mb-10">
      ...
      {SelectedWork === 'chat' ?
        (
          <div className='flex flex-col w-full h-screen justify-center items-center bg-gray-100'>
            ...
            <div className="mb-4 border gap-2 flex items-center justify-center w-4/5 rounded-4xl w-fit pl-4 pr-2">
